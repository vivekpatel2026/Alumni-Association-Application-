	...
	return (
		<div>
			<section
				...
				style={{
					backgroundImage: 'url("flex-ui-assets/elements/pattern-light.svg")',
					...
					<div className="container px-4 mx-auto">
						<div className="flex flex-wrap items-center">
							<div className="w-full lg:w-1/2 mb-20 lg:mb-0">
								<span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-white bg-blue-600 font-medium uppercase rounded-9xl">
									Welcome Alumni
								</span>
								<h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight text-gray-800 font-bold tracking-tight">
									Reconnect with Your Alumni Network.
								</h1>
								<p className="mb-8 text-lg md:text-xl leading-7 text-gray-600 font-medium">
									Join us in fostering a vibrant community of alumni and stay connected with your peers.
								</p>
								<ul className="list-disc pl-5">
									<li className="mb-4 text-lg md:text-xl leading-7 text-gray-600 font-medium">
